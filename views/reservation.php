            ...
            <div class="col-12 col-md-8 mx-auto">
                <?php
                    ...
                    for($i=1; $i<=40; $i++){
                        ...
                        ?>
                        <input type="checkbox" class="btn-check" name="seats[]" id="<?=$seat.$k.$row['coach'] ?>" value="<?=$seat.$k?>" autocomplete="off" <?php if(strpos($seats, $seat.$k)) echo "checked"; ?> disabled > 
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                        ...
                        $ticketAssoc = getAllTickets();
                        while($ticketDetails = mysqli_fetch_array($ticketAssoc, MYSQLI_ASSOC)){
                            if($ticketDetails['coach']==$checkCoach && $ticketDetails['date'] == $checkDate){
